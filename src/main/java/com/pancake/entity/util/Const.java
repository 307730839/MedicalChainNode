 ...
 */
public class Const {
    public static String BlockChainConfigFile = "D:\\KeyPair\\blockchain-config-test.json";
            //Const.class.getClassLoader().getResource("blockchain-config-test.json").getPath();

    public static String PvtKeyFile = "D:\\KeyPair\\privateKey.txt";
    public static String PubKeyFile = "D:\\KeyPair\\publicKey.txt";
