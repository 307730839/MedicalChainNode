...
public class CommittedMessageService {
    ...
    public void procCMTDM(CommittedMessage cmtdMsg, ClientMessage clientMessage, NetAddress netAddress) {
        ...
        String prefix = netAddress.toString()  + ".";
        String blockChainCollection = null;
        String txCollection = null;
        String cmtdMsgCollection = null;
        String lbiCollection = null;

        String runMod = null;
        runMod = JsonUtil.getRunMod(Const.BlockChainConfigFile);
        if(runMod.equals("test")) {
            blockChainCollection = prefix + Const.BLOCK_CHAIN;
            txCollection = prefix + Const.TX;
            cmtdMsgCollection = prefix + Const.CMTDM;
            lbiCollection = prefix + Const.LAST_BLOCK_ID;

        }
        else{
            blockChainCollection =  Const.BLOCK_CHAIN;
            txCollection =  Const.TX;
            cmtdMsgCollection =  Const.CMTDM;
            lbiCollection =  Const.LAST_BLOCK_ID;
        }
